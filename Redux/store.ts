import { TYPRE_PERSIST_REDUCER, WHITE_LIST_PERSIT_REDUX } from '@/Constant/redux'
...
export const makeStore = () => {
  ...
  const persistedReducer = persistReducer<TYPRE_PERSIST_REDUCER>(persistConfig, reducer)
